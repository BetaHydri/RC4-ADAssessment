...
>
> **What does `RC4DefaultDisablementPhase = 1` do then?** It enables **Enforcement preparation** — the KDC begins internally tracking which accounts would be affected, but does not block any tickets. The audit events themselves are generated by the security update's detection logic, not gated by the phase value.
>
