function Invoke-RC4AssessmentComparison {
<#
.SYNOPSIS
  Compare two RC4/DES assessment JSON exports to track remediation progress.
.DESCRIPTION
  Loads two JSON assessment files (baseline and current) and compares changes in
  DC encryption, trust settings, KDC registry, KDCSVC events, account encryption,
  event log patterns, and overall security posture.
...
.EXAMPLE
  Invoke-RC4AssessmentComparison -BaselineFile "C:\Reports\assessment-2025-01.json" -CurrentFile "C:\Reports\assessment-2025-03.json"
#>
    [CmdletBinding()]
    param(
