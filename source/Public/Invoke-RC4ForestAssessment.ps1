function Invoke-RC4ForestAssessment {
<#
.SYNOPSIS
...
.EXAMPLE
  Invoke-RC4ForestAssessment -ForestName "contoso.com" -AnalyzeEventLogs -ExportResults
#>
    [CmdletBinding()]
    param(
        [Parameter()]
    ...
    if ($ExportResults) {
        ...
        $forestResults | ConvertTo-Json -Depth 10 | Out-File -FilePath $jsonPath
