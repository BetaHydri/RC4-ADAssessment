...
try {
    ...
    if ($ExportResults) {
        ...
        $results | ConvertTo-Json -Depth 10 | Out-File -FilePath $jsonPath -Encoding ([System.Text.Encoding]::UTF8)
        ...
        if ($IncludeGuidance) {
            ...
            $guidanceText | Out-File -FilePath $guidancePath -Encoding ([System.Text.Encoding]::UTF8)
